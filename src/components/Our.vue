<template>
    <div class="fit row no-wrap justify-around items-center content-center">
      <div style="width: 70%;">
      <div class="fit row no-wrap justify-around" style="width:70%">
        <div class="column" style="mnargin-top:40px">
          <q-avatar style="width:300px;height: 300px;">
            <img src="https://xtrm.foxthemes.me/wp-content/uploads/2019/02/group-12-copy-2@2x.jpg">
          </q-avatar><br>
          <span class="text-h5" style="margin-left:80px;">Anny Wong</span><br>
